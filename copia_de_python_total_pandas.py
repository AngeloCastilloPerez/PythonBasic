...
Original file is located at
    https://colab.research.google.com/drive/1hjx8uz4zGACdEwI9kWYbBAfxMBbWAak5
...
numeros = pd.Series([1,2,3,5,67,45,344,53])
numeros.mean()
...
ventas_autos.to_csv("/content/drive/MyDrive/ventas_autoscopia.csv")
